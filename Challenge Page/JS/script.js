...
const exit_btn = info_box.querySelector(".buttons .exitQuiz");
const continue_btn = info_box.querySelector(".buttons .continue");
const quiz_box = document.querySelector(".quiz_box");
const result_box = document.querySelector(".result_box");
const option_list = document.querySelector(".option-container");
...
const next_btn = document.querySelector(".next-question .btn-next");
